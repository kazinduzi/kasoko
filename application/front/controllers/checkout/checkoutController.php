...
class CheckoutCheckoutController extends BaseController
{
	...
	foreach ($orderData['products'] as $product){
	    ...
	    $productsHtml .= '<td style="padding:10px; border:1px solid #d6d4d4">'.String::currency_format($product['price']).'</td>';
	    $productsHtml .= '<td style="padding:10px; border:1px solid #d6d4d4">'.$product['quantity'].'</td>';
	    $productsHtml .= '<td style="padding:10px; border:1px solid #d6d4d4">'.String::currency_format($product['total']).'</td>';
	    $productsHtml .= '<td style="padding:10px; border:1px solid #d6d4d4">'.String::currency_format($product['tax']).'</td>';
	    $productsHtml .= '</tr>';
	}
	...
	$search_replace = array(
	    ...
	    '{total_paid}' => String::currency_format($orderData['grand_total']),
	    '{total_tax_paid}' => String::currency_format($total_tax),
	    '{total_shipping}' => String::currency_format(0),
