 ...
 */
		...
		CKEDITOR.lang.fo = {
			...
			specialChar: {toolbar: 'Set inn sertekn', title: 'Vel sertekn', options: 'Special Character Options'},
			link: {
			...
			smiley: {toolbar: 'Smiley', title: 'Vel Smiley', options: 'Smiley Options'},
			...
			fontSize: {label: 'Skriftstødd', voiceLabel: 'Font Size', panelTitle: 'Skriftstødd'},
			colorButton: {
