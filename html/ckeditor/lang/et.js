 ...
 */
		...
		CKEDITOR.lang.et = {
			...
			specialChar: {toolbar: 'Sisesta erimärk', title: 'Vali erimärk', options: 'Special Character Options'},
			link: {
			...
			form: {title: 'Vormi omadused', menu: 'Vormi omadused', action: 'Toiming', method: 'Meetod', encoding: 'Encoding'},
			select: {
			...
			smiley: {toolbar: 'Emotikon', title: 'Sisesta emotikon', options: 'Smiley Options'},
			...
			pasteText: {button: 'Kleebi tavalise tekstina', title: 'Kleebi tavalise tekstina'},
			templates: {
				button: 'Šabloon',
			...
			font: {label: 'Kiri', voiceLabel: 'Font', panelTitle: 'Kiri'},
			fontSize: {label: 'Suurus', voiceLabel: 'Font Size', panelTitle: 'Suurus'},
			colorButton: {
