...
CKEDITOR.lang.af = {
    ...
    form: {title: 'Form eienskappe', menu: 'Form eienskappe', action: 'Aksie', method: 'Metode', encoding: 'Encoding'},
    select: {
    ...
    textarea: {title: 'Karakter area eienskappe', cols: 'Kolom', rows: 'Reie'},
    textfield: {
    ...
    hidden: {title: 'Blinde strook eienskappe', name: 'Naam', value: 'Waarde'},
    image: {
    ...
    smiley: {toolbar: 'Smiley', title: 'Voeg Smiley by', options: 'Smiley Options'},
    ...
    justify: {left: 'Links rig', center: 'Rig Middel', right: 'Regs rig', block: 'Blok paradeer'},
    ...
    pasteText: {button: 'Voeg slegs karakters by', title: 'Voeg slegs karakters by'},
    templates: {
        button: 'Templates',
    ...
    font: {label: 'Karakters', voiceLabel: 'Font', panelTitle: 'Karakters'},
    fontSize: {label: 'Karakter grote', voiceLabel: 'Font Size', panelTitle: 'Karakter grote'},
    colorButton: {
