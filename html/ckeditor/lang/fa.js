 ...
 */
		...
		CKEDITOR.lang.fa = {
			...
			specialChar: {toolbar: 'گنجاندن نویسهٴ ویژه', title: 'گزینش نویسهٴویژه', options: 'Special Character Options'},
			link: {
			...
			form: {title: 'ویژگیهای فرم', menu: 'ویژگیهای فرم', action: 'رویداد', method: 'متد', encoding: 'Encoding'},
			select: {
			...
			smiley: {toolbar: 'خندانک', title: 'گنجاندن خندانک', options: 'Smiley Options'},
			...
			font: {label: 'قلم', voiceLabel: 'Font', panelTitle: 'قلم'},
			fontSize: {label: 'اندازه', voiceLabel: 'Font Size', panelTitle: 'اندازه'},
			colorButton: {
