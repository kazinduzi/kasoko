...
CKEDITOR.lang.it = {
    ...
    smiley: {toolbar: 'Emoticon', title: 'Inserisci emoticon', options: 'Smiley Options'},
    elementsPath: {eleLabel: 'Elements path', eleTitle: '%1 elemento'},
    ...
    fontSize: {label: 'Dimensione', voiceLabel: 'Dimensione Font', panelTitle: 'Dimensione'},
    colorButton: {
